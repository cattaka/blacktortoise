...
package net.cattaka.android.ultimatetank.db;

import java.util.List;

import net.cattaka.android.ultimatetank.entity.MySocketAddress;
import net.cattaka.android.ultimatetank.entity.handler.MySocketAddressHandler;
import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

public class UltimateTankDbHelper extends SQLiteOpenHelper {
    public static final String DB_NAME = "UltimateTank.db";

    public UltimateTankDbHelper(Context context) {
