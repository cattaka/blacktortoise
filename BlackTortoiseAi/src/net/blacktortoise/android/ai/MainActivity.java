...
public class MainActivity extends Activity {
    ...
    private void updateCapture() {
        if (mCapture.grab()) {
            ...
            //
            // Rect rect = new Rect(m4.cols() / 4, m4.rows() / 4, m4.cols() / 2,
            // m4.rows() / 2);
            //
            // KeyPoint[] keypoints;
            ...
            // mTagDetector.resetMatch = false;
            // mTagDetector.takeMatchNum = 5;
            // mTagDetector.tagItem = new TagItem(rect.width, rect.height);
            // }
            // if (mTagDetector.takeMatchNum > 0) { // Extract keypoints for
            // // tag
            // mTagDetector.takeMatchNum--;
            ...
            // mTagDetector.tagItem.addFrame(queryDescriptors, mokp.toArray());
            // }
            // { // Marking keypoints
            ...
            // }
            //
            // if (mTagDetector.tagItem != null) {
            // for (int k = 0; k < mTagDetector.tagItem.getCount(); k++) {
            // List<MatOfDMatch> matches = new ArrayList<MatOfDMatch>();
            // Mat queryDescriptors = mTagDetector.tagItem.getDescriptors(k);
            // KeyPoint[] queryKeyPoints = mTagDetector.tagItem.getKeyPoints(k);
            // Mat trainDescriptors = descriptors;
            // mTagDetector.matcher.knnMatch(queryDescriptors, trainDescriptors,
            // matches,
            // 2);
            //
            ...
            // Scalar color = new Scalar(0xFF * m.distance / maxDistance,
            // 0xFF, 0, 0);
            // Core.circle(m4, kp.pt, 10, color, -1);
            // src.add(queryKeyPoints[m.queryIdx].pt);
